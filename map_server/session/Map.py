...
from map_server.pyWrappers import *
from map_server.utils.data import EnumArea
from map_server.utils.data import EnumNpc
from map_server.utils.data import EnumGameObject
from map_server.utils.data import EnumPresetType
...
class Map:
    ...
    def read_room_presets(self, p_room2: POINTER(Room2)):
        ...
        while p_preset:
            ...
            if preset_type == EnumPresetType.tile:
                self.read_room_exits(p_room2, p_preset, pos_x, pos_y)

            p_preset = p_preset.contents.pPresetNext

    def read_room_exits(self, p_room2, p_preset, pos_x, pos_y):
    ...
    def add_outdoor_exits(self, position=None):
        if position is None:
            return
